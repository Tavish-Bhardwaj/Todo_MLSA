  ...
  return (
    <>
      ...
      <div className="mx-9 my-10 rounded-xl p-5 bg-green-100 h-screen">
        <h1 className='font-bold text-center text-2xl '> DO-IT Your Task Manager</h1>
        ...
        <div className="todos">
          ...
          {todos.map(item=>{return (showFinished || !item.isCompleted) && <div key={item.id} className='todo flex my-3 justify-between' >
              ...
              <div className="buttons flex h-full ">
                <button onClick={()=> handleEdit(e,item.id)} className='bg-green-800 hover:bg-green-950 p-2 py-1 text-sm font-bold text-white rounded-md mx-1'> 
                  Edit
                </button>
                <button onClick={()=> handleDelete(e,item.id)} className='bg-green-800 hover:bg-green-950 p-2 py-1 text-sm font-bold text-white rounded-md mx-1'> 
                  Delete
                </button>
              </div>
